      ...
      <div className="mx-auto max-w-lg px-4 py-16 text-center sm:px-6">
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-8">
          ...
          <p className="mt-2 text-sm text-emerald-700">
            Děkujeme. Jakmile najdeme vhodného poskytovatele ve vaší lokalitě, ozveme se vám na e-mail.
          </p>
          <Link href="/marketplace" className="btn-primary mt-6 inline-flex">
            Prohlédnout dostupné služby
          </Link>
        </div>
      </div>
    )
    ...
    <div className="mx-auto max-w-lg px-4 py-10 sm:px-6">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm text-slate-600">
          Zanechte nám poptávku. I když ve vaší lokalitě zatím nemáme poskytovatele, postaráme se a ozveme se vám,
          jakmile někoho vhodného najdeme.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-bold text-slate-800">Kdy by se hodilo? <span className="font-normal text-slate-400">(nepovinné)</span></label>
            <input
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-bold text-slate-800">Telefon <span className="font-normal text-slate-400">(nepovinné)</span></label>
            <input
              type="tel"
              value={form.phone}
        ...
        {isLoggedIn ? (
          <div className="space-y-1.5">
            <label className="text-sm font-bold text-slate-800">Fotky <span className="font-normal text-slate-400">(nepovinné)</span></label>
          ...
          <p className="rounded-xl bg-slate-50 px-4 py-3 text-xs text-slate-500">
            Chcete přiložit fotky? <Link href="/prihlasit?next=/poptavka" className="font-bold text-emerald-600 hover:underline">Přihlaste se</Link> – poptávku ale můžete odeslat i bez přihlášení.
          </p>
        )}
