    ...
    <div>
      ...
      <div className="print:hidden">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Vyberte jednu a dejte Tisknout. Místo tiskárny můžete v okně zvolit „Uložit jako PDF" a poslat to do tiskárny na rohu.
        </p>
        ...
        <p className="mt-2 rounded-xl bg-slate-50 px-3 py-2.5 text-xs leading-relaxed text-slate-500">
          V okně tisku vypněte „záhlaví a zápatí" a nechte měřítko na 100 %, jinak rozměry nesednou.
          Na samolepku kupte samolepicí papír A4 — jeden arch vyjde na pár korun a vytisknete z něj několik koleček.
        </p>
      ...
      <div className="mt-6 flex justify-center rounded-2xl bg-slate-100 p-6 print:mt-0 print:bg-white print:p-0">
        ...
        {sablona === 'stojanek' && (
          <div className="tpl stojanek">
            <p className="st-nadpis">Rezervujte si příští termín</p>
            <div className="st-qr" ref={setRef('stojanek')} />
            <p className="st-text">Namiřte foťák na kód — uvidíte volné termíny</p>
        ...
        {sablona === 'plakat' && (
          <div className="tpl plakat">
            ...
            <p className="p-podnadpis">Vyberte si termín, který vám sedí — kdykoli, i večer</p>
