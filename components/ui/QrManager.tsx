...
import type { QrCil, QrKod, QrStatistika } from '@/lib/actions/qr-types'
  ...
  if (cile.length === 0) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center">
        ...
        <p className="font-bold text-slate-800">Nejdřív potřebujete nabídku</p>
        <p className="mx-auto mt-1 max-w-sm text-sm text-slate-500">
          Kód vede na ceník a volné termíny, takže napřed musí existovat karta, kam se dá objednat.
        </p>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <label className="mb-2.5 block text-sm font-bold text-slate-600">Kam kód pošle zákazníka</label>
          ...
          <div className="grid gap-6 sm:grid-cols-[200px_1fr]">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1.5 text-xs text-slate-400">
                Schválně krátký — kdo nemá po ruce foťák, přepíše ho z papíru. Vede vždy na to, co máte v ceníku dnes.
              </p>

              <label className="mb-2 mt-5 block text-sm font-bold text-slate-600">Stáhnout samotný kód</label>
              ...
              <p className="mt-1.5 text-center text-[11px] text-slate-400">
                Vizitka · samolepka na zrcadlo · stojánek na pult · plakát A4
              </p>
            </div>
          </div>
        ) : null}
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          ...
          {stat.celkem === 0 && (
            <p className="mt-3 rounded-xl bg-amber-50 px-3 py-2.5 text-xs leading-relaxed text-amber-800">
              Zatím nikdo — kód čeká na vytištění. Nejlíp funguje samolepka na zrcadle u křesla a na vnitřní
              straně dveří: zákazník ji vidí přesně ve chvíli, kdy přemýšlí, kdy zase přijde.
            </p>
          )}
          <p className="mt-2 text-xs text-slate-400">
            Počítáme jen počet načtení. Nikoho nesledujeme a neukládáme, kdo skenoval.
          </p>
        </div>
      )}
