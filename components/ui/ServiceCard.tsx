    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-2 p-4">
        ...
        <div className="mt-auto flex items-end justify-between gap-2 border-t border-slate-100 pt-3">
          ...
          <Link href={`/sluzby/${service.id}`} className="whitespace-nowrap rounded-xl bg-emerald-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-emerald-600">
            Zobrazit
          </Link>
        </div>
      </div>
